...
class _AuthScreenState extends State<AuthScreen> {
  ...
  final _signUpSellerFormKey = GlobalKey<FormState>();
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                tileColor: _auth == Auth.signupSeller
                    ? GlobalVariables.backgroundColor
                    : GlobalVariables.greyBackgroundCOlor,
                title: const Text(
              ...
              if (_auth == Auth.signupSeller)
                Container(
                  color: GlobalVariables.backgroundColor,
                  padding: EdgeInsets.all(8),
                  child: Form(
                    key: _signUpSellerFormKey,
                    child: Column(
                      children: [
                        CustomTextField(
                          hintText: "Name",
                        ...
                        CustomButton(
                          ...
                          color: GlobalVariables.secondaryColor,
                          onTap: () {
                            if (_signUpSellerFormKey.currentState!.validate()) {
                              signUpSeller();
                            }
                          },
                        )
